...
public class SearchServlet extends HttpServlet{
	...
	dispatcher.forward(req, resp);
			 ...
			 * out.println("<a style='float:right' href='./logout'>Logout</a>"); if(info !=
			 * null) {
			 * 
			 ...
			 * 
			 * out.println("<td>"); out.println(info.getEmail()); out.println("</td>");
			 * out.println("</tr>"); out.println("</table>"); } else {
